...
public class SwaggerConfig {
     ...
     */
	@Bean
	public OpenAPI springSustentatechOpenAPI() {
        ...
        return new OpenAPI()
				.info(new Info()
					...
					.description("Projeto Integrador Sustentatech")
					.version("v0.0.1")
				.license(new License()
					.name("Sustentatech")
					.url("https://github.com/sustentatech"))
				.contact(new Contact()
					.name("Sustentatech")
					.url("https://github.com/sustentatech")
					.email("contatosustentatech@gmail.com")))
